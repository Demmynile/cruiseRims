...
const Features = ({ title, subtitle }: featureProps) => {
  return (
    <div className=" sm:w-[320px] sm:h-[320px] md:w-[364px] md:h-[350px] lg:w-[330px] lg:h-[402px] xl:w-[404px] xl:h-[450px]  bg-black rounded-lg flex flex-col space-y-9 items-center justify-center p-8 mt-9">
